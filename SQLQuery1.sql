...
ALTER PROCEDURE RECUPERARPLANILLAUSUARIO
@IDUSUARIO INT
AS
BEGIN


SELECT PU.FECHA_REGISTRO,PRO.NOMBRE AS NOMBREPROYECTO, PRO.NUM_PROYECTO AS NUMPROYECTO,PRO.ID AS IDPROYECTO,A.NOMBRE AS NOMBREACTIVIDAD,PU.REGISTRO_HH_PROYECTO AS HHREGISTRADAS
,PU.OBSERVACIONES
...
INNER JOIN ACTIVIDADES A ON PU.ACTIVIDAD = A.ID
