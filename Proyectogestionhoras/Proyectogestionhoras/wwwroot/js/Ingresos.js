...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById("agregarFilaIngresos").addEventListener("click", function () {
        ...
        setTimeout(() => {
            ...
            const nuevosMontos = document.querySelectorAll('input[name*="Montous"], input[name*="Montoclp"], input[name*="Iva"]');
        ...
        $('#agregarFilaIngresos').on('click', function (e) {
            ...
            const nuevaFila = `
                <tr>
                    ...
                    <td class="p-2 border border-gray-300 text-right"><input type="text" name="Montous" class="form-control text-right px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 w-20" /></td>
