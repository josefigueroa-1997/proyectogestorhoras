...
namespace Proyectogestionhoras.Services.Interface
{
    public interface ICliente
    {
        ...
        public Task<bool> RegistrarCliente(string nombre,string direccion,string ciudad,string pais,string telefono,string? pagweb,string? linkedin,string? instagram,int idcliente);
