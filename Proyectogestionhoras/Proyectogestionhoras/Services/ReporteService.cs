                    ...
                    using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ReporteMargenProyectoDTO datos = new()
                            {
                                ...
                                MontoReal = reader.IsDBNull(reader.GetOrdinal("TOTAL_INGRESOS_REALES")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_INGRESOS_REALES")),
                                MontoForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_INGRESOS_Forecast")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_INGRESOS_Forecast")),
                                TotalGastos = reader.IsDBNull(reader.GetOrdinal("TOTAL_GASTOS")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_GASTOS")),
                                TotalGastosReales = reader.IsDBNull(reader.GetOrdinal("TOTAL_GASTOS_REALES")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_GASTOS_REALES")),
                                TotalGastosForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_GASTOS_FORECAST")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_GASTOS_FORECAST")),
                                TotalServicios = reader.IsDBNull(reader.GetOrdinal("TOTAL_SERVICIOS")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_SERVICIOS")),
                                TotalServiciosReales = reader.IsDBNull(reader.GetOrdinal("TOTAL_SERVICIOS_REALES")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_SERVICIOS_REALES")),
                                TotalServiciosForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_SERVICIOS_FORECAST")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_SERVICIOS_FORECAST")),
                                CostosSocios = reader.IsDBNull(reader.GetOrdinal("COSTO_SOCIOS")) ? 0 : reader.GetDecimal(reader.GetOrdinal("COSTO_SOCIOS")),
                                CostosSociosReales = reader.IsDBNull(reader.GetOrdinal("TOTAL_SOCIOS_REAL")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_SOCIOS_REAL")),
                                CostosSociosForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_SOCIOS_FORECAST")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_SOCIOS_FORECAST")),
                                CostosStaff = reader.IsDBNull(reader.GetOrdinal("COSTO_STAFF")) ? 0 : reader.GetDecimal(reader.GetOrdinal("COSTO_STAFF")),
                                CostosStaffReales = reader.IsDBNull(reader.GetOrdinal("TOTAL_STAFF_REAL")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_STAFF_REAL")),
                                CostosStaffForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_STAFF_FORECAST")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_STAFF_FORECAST")),
                                CostoConsultorA = reader.IsDBNull(reader.GetOrdinal("COSTO_CONSULTORES")) ? 0 : reader.GetDecimal(reader.GetOrdinal("COSTO_CONSULTORES")),
                                CostoConsultorReal = reader.IsDBNull(reader.GetOrdinal("TOTAL_CONSULTORES_REAL")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_CONSULTORES_REAL")),
                                CostoConsultorForecast = reader.IsDBNull(reader.GetOrdinal("TOTAL_CONSULTORES_FORECAST")) ? 0 : reader.GetDecimal(reader.GetOrdinal("TOTAL_CONSULTORES_FORECAST")),
