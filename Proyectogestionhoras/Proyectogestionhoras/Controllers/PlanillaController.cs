        ...
        public async Task<ActionResult> ExportarExcel(int idplanilla)
        {
           // var nombre = HttpContext.Session.GetString("nombre");
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[10, 3].Value = "Número de Proyecto";
                worksheet.Cells[10, 4].Value = "Proyecto";
                worksheet.Cells[10, 5].Value = "Id Cuenta";
                worksheet.Cells[10, 6].Value = "Cuenta";
                worksheet.Cells[10, 7].Value = "CCosto";              
                worksheet.Cells[10, 8].Value = "HH Registradas";
                worksheet.Cells[10, 9].Value = "Costo Unitario";
                worksheet.Cells[10, 10].Value = "Costo Total";
                worksheet.Cells[10, 11].Value = "Observaciones";
               
                
                /*worksheet.Cells[10, 9].Value = "Segmento";*/

                using (var rango = worksheet.Cells[10, 1, 10, 11])
                {
                ...
                for (int i = 0; i < planillas.Count(); i++)
                {
                    ...
                    worksheet.Cells[indice, 4].Value = planilla.Nombre;
                    worksheet.Cells[indice, 5].Value = planilla.IDCUENTA == 0 ? "-" : planilla.IDCUENTA;
                    worksheet.Cells[indice, 6].Value = planilla.Cuenta;
                    worksheet.Cells[indice, 7].Value = planilla.ccosto;
                    worksheet.Cells[indice, 8].Value = planilla.HHregistradas;
                    worksheet.Cells[indice, 9].Style.Numberformat.Format = "#,##0";
                    worksheet.Cells[indice, 9].Value = planilla.CostoUnitario == 0 ? "" : planilla.CostoUnitario;
                    worksheet.Cells[indice, 10].Style.Numberformat.Format = "#,##0";
                    worksheet.Cells[indice, 10].Value = planilla.CostoTotal == 0 ? "" : planilla.CostoTotal;
                    worksheet.Cells[indice, 11].Value = planilla.Observaciones;
                ...
                worksheet.Cells[indice + 1, 7].Value = "Totales";
                worksheet.Cells[indice + 1, 8].Value = totalhoras;
                worksheet.Cells[indice + 1,10].Style.Numberformat.Format = "#,##0";
                worksheet.Cells[indice + 1, 10].Value = totalcosto;
